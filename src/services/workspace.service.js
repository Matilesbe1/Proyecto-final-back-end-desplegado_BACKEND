...
class WorkspaceService {
    static async getAll(user_id) {
        ...
        console.log("USER_ID GETALL:", user_id)
        return members
    }
    ...
    static async create(user_id, name, url_img) {
        ...
        const id_workspace = workspace_created._id;

        //Crear al miembro con role de  admin (Creador del workspace)
        await MemberWorkspaceRepository.create(user_id, id_workspace, 'admin')
        console.log("USER_ID CREATE:", user_id)
